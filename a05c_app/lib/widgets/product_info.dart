...
class ProductInfo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    streamSubscription =
        context.read<UiCubit>().stream.listen(handleCloseAction);
    ...
    return WillPopScope(
      onWillPop: () {
        context.read<UiCubit>().actionUiShowProduct(product: null);
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            context
                                .read<CartCubit>()
                                .actionCartAdd(product: product);
                            context
                                .read<UiCubit>()
                                .actionUiShowProduct(product: null);
                          },
                        ),
                      ),
                    ],
