...
class _$__ViewModel implements __ViewModel {
  ...
  @override
  String toString() {
    return '_ViewModel(categorySelected: $categorySelected, categoryLoading: $categoryLoading, categories: $categories)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, categorySelected, categoryLoading, categories);
...
abstract class __ViewModel implements _ViewModel {
  const factory __ViewModel(
      ...
      required final CategoriesListModel categories}) = _$__ViewModel;
