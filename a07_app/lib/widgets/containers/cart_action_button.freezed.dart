...
part of 'cart_action_button.dart';
...
/// @nodoc
mixin _$_ViewModel {
  int get cartNum => throw _privateConstructorUsedError;
...
class __$ViewModelCopyWithImpl<$Res, $Val extends _ViewModel>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      cartNum: null == cartNum
          ? _value.cartNum
          : cartNum // ignore: cast_nullable_to_non_nullable
              as int,
    ) as $Val);
  }
}
...
class _$__ViewModel implements __ViewModel {
  const _$__ViewModel({required this.cartNum});
  ...
  @override
  String toString() {
    return '_ViewModel(cartNum: $cartNum)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.cartNum, cartNum) || other.cartNum == cartNum));
  }

  @override
  int get hashCode => Object.hash(runtimeType, cartNum);
...
abstract class __ViewModel implements _ViewModel {
  const factory __ViewModel({required final int cartNum}) = _$__ViewModel;
