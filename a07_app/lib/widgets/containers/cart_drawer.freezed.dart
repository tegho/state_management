...
abstract class _$ViewModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<CartItem> cart, double cartSum});
}
...
class _$__ViewModel implements __ViewModel {
  const _$__ViewModel(
      {required final List<CartItem> cart, required this.cartSum})
      : _cart = cart;
  ...
  @override
  String toString() {
    return '_ViewModel(cart: $cart, cartSum: $cartSum)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_cart), cartSum);
...
abstract class __ViewModel implements _ViewModel {
  const factory __ViewModel(
      ...
      required final double cartSum}) = _$__ViewModel;
