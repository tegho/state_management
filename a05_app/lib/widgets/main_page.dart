...
class MainPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    streamSubscription = context.read<UiBloc>().stream.listen(handleUiEvents);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: FilledButton(
            ...
            onPressed: () {
              context.read<UiBloc>().add(ActionUiSelectCategory(open: true));
            }),
            ...
            builder: (context, snapshot) {
              ...
              return SizedBox(
                ...
                child: FilledButton(
                    ...
                    onPressed: () {
                      context.read<UiBloc>().add(ActionUiShowCart(open: true));
                    }),
              );
            },
          ),
      ...
      onEndDrawerChanged: (isOpened) {
        if (!isOpened) {
          context.read<UiBloc>().add(ActionUiShowCart(open: false));
        }
      },
      body: SafeArea(
              ...
              onNotification: (scrollNotification) {
                if (scrollNotification is ScrollEndNotification) {
                  if (controller.offset >=
                    ...
                    context.read<CatalogBloc>().add(ActionCatalogLoadMore());
                  }
                }
                return false;
              },
